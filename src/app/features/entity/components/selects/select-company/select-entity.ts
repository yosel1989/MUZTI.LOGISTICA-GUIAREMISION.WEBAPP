import { Component, OnDestroy, OnInit, AfterViewInit, Input, signal, EventEmitter, Output, input } from '@angular/core';
...
export class SelectEntity implements OnInit, AfterViewInit, OnDestroy{
    ...
    type = input<'empresa' | 'persona' | null>(null);
