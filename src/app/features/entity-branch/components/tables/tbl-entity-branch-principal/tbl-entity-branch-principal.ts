...
export class TblEntityBranchPrincipal implements OnInit, AfterViewInit, OnDestroy{
    ...
    evtOnCreate(): void{
      this.ref = this.dialogService.open(MdlEntityBranchCreate,  {
        ...
        modal: true,
        position: 'top',
        header: '<span class="inline-flex items-center justify-center w-9! h-9! rounded-lg! bg-slate-200! me-2!"><span class="pi pi-plus text-[14px]!"></span></span> Nuevo establecimiento',
    ...
    evtOnEdit(): void{
      ...
      this.ref = this.dialogService.open(MdlEntityBranchEdit,  {
        ...
        modal: true,
        position: 'top',
        header: '<span class="inline-flex items-center justify-center w-9! h-9! rounded-lg! bg-slate-200! me-2!"><span class="pi pi-pencil text-[14px]!"></span></span> Editar establecimiento',
        styleClass: 'max-h-none! slide-down-dialog',
        maskStyleClass: 'overflow-y-auto py-4',
        appendTo: 'body',
        inputValues:{
    ...
    evtShowSeries(): void{
      ...
      this.ref = this.dialogService.open(MdlEntityBranchSerieList,  {
        ...
        modal: true,
        position: 'top',
        header: '<span class="inline-flex items-center justify-center w-9! h-9! rounded-lg! bg-slate-200! me-2!"><span class="fa-light fa-hashtag text-[14px]!"></span></span> Administración de series',
