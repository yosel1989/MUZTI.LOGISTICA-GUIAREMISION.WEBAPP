...
import { SecurityPersonalReasonForTransferCreateDto, SecurityPersonalReasonForTransferDto } from "../models/security-personal-reason-for-transfer";
...
export class SecurityPersonalReasonForTransferApiService {

    private httpClient = inject(HttpClient);
    private baseUrl = environment.apiUrl + '/security-person-reason-for-transfers';
     ...
     */
    create(request: SecurityPersonalReasonForTransferCreateDto): Observable<number>{
     ...
     */
    getCollection(securityPersonalId: number, pageNumber: number, pageSize: number, search: string | null): Observable<TableData<SecurityPersonalReasonForTransferDto[]>>{
        ...
        return this.httpClient.get<TableData<SecurityPersonalReasonForTransferDto[]>>(`${this.baseUrl}/${securityPersonalId}/${pageNumber}/${pageSize}`, { params: httpParams })
     ...
     */
    delete(securityPersonalId: number, reasonForTransferId: number): Observable<boolean>{

        return this.httpClient.delete<boolean>(`${this.baseUrl}/${securityPersonalId}/${reasonForTransferId}`);
    }
