...
import { TransportistaDto, TransportistaSugeridoDto } from '@features/transportista/models/transportista';

@Component({
  selector: 'app-mdl-lista-transportista',
  templateUrl: './mdl-lista-transportista.html',
  styleUrls: ['./mdl-lista-transportista.scss'],                          
  imports: [
    InputTextModule,
    ReactiveFormsModule,
    FormsModule,
...
export class MdlListaTransportistaComponent implements OnInit, AfterViewInit, OnDestroy{
  ...
  @Output() OnSelect: EventEmitter<TransportistaDto> = new EventEmitter<TransportistaDto>();
  @Output() OnClose: EventEmitter<boolean> = new EventEmitter<boolean>();

  data = signal<TransportistaSugeridoDto[]>([]);
  selected: TransportistaSugeridoDto | undefined;
  cols: TableColumn[] = [];
  ...
  getData(): void{
    ...
    .subscribe({
      next: (value: TransportistaSugeridoDto[]) => {
        this.data.set(value);
      },
